...
import vine.graphics.SceneLayer;
...
public final class Launch
{
    ...
    private static void run(final String... commandLine)
    {
        ...
        /*
         * switch (Launch.parseEngineMode(commandLine)) { case DEBUG:
         * PropertyConfigurator.configure(Launch.class.getClassLoader().
         * getResource("log4j-debug.properties")); // StatMonitor.logGC();
         * break; case PRODUCTION:
         * PropertyConfigurator.configure(Launch.class.getClassLoader().
         * getResource("log4j-production.properties")); break; case EDITOR:
         * PropertyConfigurator.configure(Launch.class.getClassLoader().
         * getResource("log4j-debug.properties")); break; case BENCHMARK:
         * default:
         * PropertyConfigurator.configure(Launch.class.getClassLoader().
        ...
        final Layer sceneLayer = new SceneLayer(game);
