...
public class Contact
{
    ...
    {
        return collider.toString() + "," + collided.toString() + ",Normal:" + contactNormal.toString() + ","
    ...
    public void resolve(final float delta)
    {
        ...
        float tmpX;
        float tmpY;
        if (!GMath.isNearlyZero(GMath.abs(penetration)))
        {
        ...
        if (!GMath.isNearlyZero(separationSpeed) || GMath.isNearlyZero(totalInvMass))
        {
            return;
        }
